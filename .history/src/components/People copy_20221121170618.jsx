    ...
    <>
      <section className="container">
        <div className="flex items-end justify-between py-4">
          <h1 className="text-4xl text-[#F4E3CF]">Documents</h1>
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="border-4 border-[#F4E3CF] text-[#F4E3CF] flex items-center justify-center">
            <HiUpload className="rounded-full w-10 h-10 mr-2" />{" "}
            <h2 className="text-xl font-semibold">Upload Your Own Video</h2>
          </div>
        </div>
      </section>
    </>
