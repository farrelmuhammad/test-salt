      ...
      <section className="container max-w-xl">
        ...
        <div class="flex flex-col space-y-5">
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                John Doe <span className="text-base font-normal">commented</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
          ...
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                John Doe <span className="text-base font-normal">added a new video</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
              <p class="text-sm flex items-center">
          ...
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                John Doe <span className="text-base font-normal">shared a document</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
              <p class="text-sm flex items-center">
          ...
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                Arjun <span className="text-base font-normal">unlocked new badge</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
              <p class="text-sm flex items-center">
          ...
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                Micheal <span className="text-base font-normal">uploaded a new video</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
              <p class="text-sm flex items-center">
          ...
          <div class="card hover:border-[#F4E3CF]">
            ...
            <div class="py-1 pl-4 truncate text-[#F4E3CF]">
              <h5 class="text-xl font-semibold">
                John Doe <span className="text-base font-normal">liked a video</span>
              </h5>
              <p class="text-base mb-3 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique!</p>
              <p class="text-sm flex items-center">
